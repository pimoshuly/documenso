                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-1">
                      ...
                      <FormDescription>
                        <Trans>The URL for this instance to send webhook events to.</Trans>
                      </FormDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      <Trans>
                        A secret that will be sent to your URL so you can verify that the request has been sent by this
                        instance.
                      </Trans>
                    </FormDescription>
                    <FormMessage />
