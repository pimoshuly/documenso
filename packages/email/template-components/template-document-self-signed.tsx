...
export const TemplateDocumentSelfSigned = ({ documentName, assetBaseUrl }: TemplateDocumentSelfSignedProps) => {
  ...
  const signUpUrl = resolveInstanceBrandingUrl('/signup', { absolute: true });
  const plansUrl = resolveInstanceBrandingUrl(branding.instanceBranding.plansUrl, { absolute: true });
