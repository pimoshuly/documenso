declare namespace NodeJS {
  export interface ProcessEnv {
    PORT?: string;
    EMAIL_QA_OUTPUT_DIR?: string;
    NEXT_PUBLIC_WEBAPP_URL?: string;
    NEXT_PUBLIC_BASE_PATH?: string;
    NEXT_PUBLIC_INSTANCE_NAME?: string;
    NEXT_PUBLIC_INSTANCE_SHORT_NAME?: string;
    NEXT_PUBLIC_INSTANCE_DESCRIPTION?: string;
    NEXT_PUBLIC_INSTANCE_WEBSITE_URL?: string;
    NEXT_PUBLIC_INSTANCE_LOGO_URL?: string;
    NEXT_PUBLIC_INSTANCE_ICON_URL?: string;
    NEXT_PUBLIC_INSTANCE_OPENGRAPH_IMAGE_URL?: string;
    NEXT_PUBLIC_INSTANCE_PRIMARY_COLOR?: string;
    NEXT_PUBLIC_INSTANCE_PRIMARY_FOREGROUND_COLOR?: string;
    NEXT_PUBLIC_INSTANCE_LEGAL_NAME?: string;
    NEXT_PUBLIC_INSTANCE_LEGAL_ADDRESS?: string;
    NEXT_PUBLIC_SUPPORT_EMAIL?: string;
    NEXT_PUBLIC_INSTANCE_EMAIL_FOOTER_TEXT?: string;
    NEXT_PUBLIC_SOURCE_CODE_URL?: string;
    NEXT_PUBLIC_INSTANCE_DOCUMENTATION_URL?: string;
    NEXT_PUBLIC_INSTANCE_SUPPORT_URL?: string;
    NEXT_PUBLIC_INSTANCE_TERMS_URL?: string;
    NEXT_PUBLIC_INSTANCE_PRIVACY_URL?: string;
    NEXT_PUBLIC_INSTANCE_PLANS_URL?: string;
